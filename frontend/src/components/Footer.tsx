    ...
    <footer className="text-white" style={{ backgroundColor: '#4f3e2d' }}>
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-bold mb-4" style={{ fontSize: '24px', fontFamily: 'Nohemi, sans-serif' }}>Menu</h4>
          ...
          <div>
            <h4 className="font-bold mb-4" style={{ fontSize: '24px', fontFamily: 'Nohemi, sans-serif' }}>Link utili</h4>
            <div className="border-b-2 border-white mb-4" style={{ width: '60px' }}></div>
            <ul className="space-y-2" style={{ fontSize: '16px' }}>
              <li>
          ...
          <div>
            <h4 className="font-bold mb-4" style={{ fontSize: '24px', fontFamily: 'Nohemi, sans-serif' }}>Community</h4>
            <div className="border-b-2 border-white mb-4" style={{ width: '60px' }}></div>
